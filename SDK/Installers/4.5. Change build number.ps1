...
$file = "E:\Work\cvsroot\MPlatform\trunk\Install\WIX\MPlatform\Include.wxi"
$new_file = "E:\Work\cvsroot\MPlatform\trunk\Install\WIX\MPlatform\New_Include.wxi"
...
Rename-Item -Path $new_file -NewName "Include.wxi" -Force
}
catch{
